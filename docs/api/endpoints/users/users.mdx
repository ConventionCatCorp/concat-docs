...
<splitColumn>
  <div>
    <h4>Permissions</h4>
    <div>
      Requires the <code>pii:basic</code> permission. Other permissions are required to access additional information, such as PII and order history.
    </div>
...
<splitColumn>
  <div>
    ...
    <attribute id="user-retrieve-req-id" name="id" type="number">
...
<splitColumn>
  <div>
    <h4>Scopes</h4>
    <div>
      Requires the <code>user:create</code> scope.
    </div>
    <div style={{ marginBottom: '1.5rem' }} />
  ...
  <div>
    <exampleBox method='POST' header='/api/users/manual' headerSubText='application/json'>
      {`{
  "addressCity": "New York",
  "addressCountry": "US",
  "addressLine1": "123 Main St",
...
<splitColumn>
  <div>
    ...
    <div style={{ marginBottom: '1.5rem' }} />
    <h4>Path Attributes</h4>
    <attribute id="user-update-req-id" name="id" type="number">
...
<splitColumn>
  ...
  <div>
    <exampleBox method='DELETE' header='/api/users/:id/pii' headerSubText='cURL'>
