  ...
  return (
    <Layout
      ...
      <main className={styles.main}>
        ...
        <p>
          Convention Cat Event Systems, Inc. ("us", "we", or "our") operates the concat.app website
        ...
        <p>
          ...
          the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible
          from concat.app.
        </p>
        ...
        <ul>
          <li>
            ...
            <p>Service is the concat.app website operated by Convention Cat Event Systems, Inc.</p>
          </li>
          <li>
        ...
        <h2>Use of Data</h2>
        <p>Convention Cat Event Systems, Inc. uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>If you are from the European Economic Area (EEA), Convention Cat Event Systems, Inc. legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
        <p>Convention Cat Event Systems, Inc. may process your Personal Data because:</p>
        <ul>
        ...
        <p>Convention Cat Event Systems, Inc. will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
        <p>Convention Cat Event Systems, Inc. will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>

        <h2>Transfer of Data</h2>
        <p>Your information, including Personal Data, may be transferred to - and maintained on - computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.</p>
        <p>If you are located outside United States and choose to provide information to us, please note that we transfer the data, including Personal Data, to United States and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
        <p>Convention Cat Event Systems, Inc. will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

        <h2>Disclosure of Data</h2>
        <h3>Business Transaction</h3>
        <p>If Convention Cat Event Systems, Inc. is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

        <h3>Disclosure for Law Enforcement</h3>
        <p>Under certain circumstances, Convention Cat Event Systems, Inc. may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

        <h3>Legal Requirements</h3>
        <p>Convention Cat Event Systems, Inc. may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Convention Cat Event Systems, Inc.</li>
        ...
        <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Convention Cat Event Systems, Inc. aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
        ...
        <ul>
          ...
          <li>
            <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where Convention Cat Event Systems, Inc. relied on your consent to process your personal information.</p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>Sentry analyses errors on the website, and report to Convention Cat Event Systems, Inc about any potential issues on the website.</p>
            <p>For more information on the privacy practices of Sentry, please visit the Sentry Privacy &amp; Terms web page: <a href="https://sentry.io/privacy/">https://sentry.io/privacy/</a></p>
          </li>
        </ul>
        ...
        <p>Direct Convention Cat Event Systems, Inc. customers utilizing our Service may collect data from their own customers at any time through the Service.  Convention Cat Event Systems, Inc. takes no ownership of this data, but rather its customers own the data they collect via the Service.</p>
        <p>To this end, Convention Cat Event Systems, Inc. holds a limited non-exclusive license to this data for the reasons of:</p>
        <ul>
          <li>Providing service to its direct customers.</li>
          <li>Determining usage statistics of the Service.</li>
          <li>Software defect testing and resolution.</li>
          <li>Billing purposes in line with outstanding billing agreements.</li>
        </ul>

        <h2>Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, please contact us by email at privacy@concat.systems.</p>
      </main>
    </Layout>
  );
}